...
public class ScoreIndicator implements Sprite {
     ...
     * Constructor.
     *
     * @param scoresDisplay - displaying the score.
    ...
    public void drawOn(DrawSurface d) {
        ...
        d.drawText(350, 17, "Score: " + Integer.toString(this.scores.getValue()), 15);
    }
    ...
    /**
     * Add the score number to the Sprite list of the game.
     *
     * @param g - the game.
     */
