...
public class Point {
    ...
    /**
     * Sets the x and y of the point to a new values.
    ...
    /**
     * Adding together two points (the X's and Y's), and create a new point.
     * @param point the point to add up (to 'this' point)
